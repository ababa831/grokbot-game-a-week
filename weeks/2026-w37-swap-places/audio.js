/**
 * WebAudio SE — punchy peaks, short tails. Swap / key / hurt / clear.
 */
(function () {
  const C = () => window.SWAP_PLACES_CONFIG;
  ...
  window.SwapPlacesAudio = AudioSys;
})();
